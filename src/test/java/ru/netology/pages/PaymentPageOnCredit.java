...
public class PaymentPageOnCredit {
    ...
    private SelenideElement invalidMonth = $(byXpath("//div[2]//span[1]/span/span/span[3]"));
    private SelenideElement invalidYear = $(byXpath("//span[2]//span[3]"));
    private SelenideElement invalidOwner = $$("span.input__sub").get(3);
    private SelenideElement invalidCVV = $(byXpath("//div[3]//span[2]//span[3]"));
    ...
    public void fillingForm(DataHelper.CardInfo cardInfo) {
        ...
        cvvField.setValue(String.valueOf(cardInfo.getCvv()));
    ...
    public void checkInvalidMonth(DataHelper.CardInfo invalidValue) {
